		...
		$scope.launch = function(which){
			switch(which){
				...
				case 'confirm':
					...
					break;
				case 'custom':
					var dlg = dialogs.create('/dialogs/form-education.html','customDialogCtrl',{},{size:'lg',keyboard: true,backdrop: false,windowClass: 'my-class'});
